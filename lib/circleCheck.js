...
function validatePosition(p) {
  if (p.x === undefined) throw new Error('[circular overlap removal] x coordinate must be defined ' + p)
  if (p.y === undefined) throw new Error('[circular overlap removal] y coordinate must be defined ' + p)
  if (p.r === undefined) throw new Error('[circular overlap removal] r circle radius must be defined ' + p)
}
